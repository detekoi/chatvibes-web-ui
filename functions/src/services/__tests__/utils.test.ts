...
describe('utils', () => {
  ...
  describe('normalizeSecretVersionPath', () => {
    ...
    it('should append /versions/latest if path does not include /versions/', () => {
      ...
      expect(utils.normalizeSecretVersionPath(path)).toBe(
        'projects/test/secrets/my-secret/versions/latest'
      );
    });
  ...
  describe('validateSpeed', () => {
    ...
    it('should reject non-number values', () => {
      expect(utils.validateSpeed('1.0' as any)).toBe(false);
      expect(utils.validateSpeed(null as any)).toBe(false);
      expect(utils.validateSpeed(undefined as any)).toBe(false);
      expect(utils.validateSpeed({} as any)).toBe(false);
    });
  });
  ...
  describe('validatePitch', () => {
    ...
    it('should reject non-number values', () => {
      expect(utils.validatePitch('0' as any)).toBe(false);
      expect(utils.validatePitch(null as any)).toBe(false);
      expect(utils.validatePitch(undefined as any)).toBe(false);
    });
  });
  ...
  describe('validateLanguageBoost', () => {
    ...
    it('should reject non-string values', () => {
      expect(utils.validateLanguageBoost(null as any)).toBe(false);
      expect(utils.validateLanguageBoost(undefined as any)).toBe(false);
      expect(utils.validateLanguageBoost(123 as any)).toBe(false);
    });
  });
