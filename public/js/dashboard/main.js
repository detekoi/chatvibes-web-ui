...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const botApiBaseUrl = window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1" ? "http://localhost:8080/api" : "https://chatvibes-tts-service-h7kj56ct4q-uc.a.run.app/api";
  const state = {
  ...
  const settingsModule = initSettingsModule({ botApiBaseUrl, apiBaseUrl, testMode }, services, {
