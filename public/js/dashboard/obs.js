 ...
 * @param {object} params
 * @param {HTMLInputElement} params.ttsUrlField
 * @param {HTMLButtonElement} params.copyTtsUrlBtn
 * @param {HTMLAnchorElement|HTMLButtonElement} params.regenerateTtsUrlBtn
 * @param {object} context
 * @param {string} context.apiBaseUrl
 * @param {boolean} context.testMode
 * @param {object} services
 * @param {() => {login: string}|null} services.getLoggedInUser
 * @returns {{loadExistingTtsUrl: (login: string) => Promise<void>, updateTtsUrl: (login: string) => Promise<void>}}
 */
export function initObsModule({ ttsUrlField, copyTtsUrlBtn, regenerateTtsUrlBtn }, context, services) {
