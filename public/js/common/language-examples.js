const LANGUAGE_EXAMPLES = {
  ...
  "French": {
    dashboard: "Bienvenue \xE0 tous sur le stream !",
  ...
  "Portuguese": {
    dashboard: "Bem-vindos todos \xE0 transmiss\xE3o!",
    viewer: "Chat, isso \xE9 real?"
  },
  "Russian": {
  ...
  "Spanish": {
    dashboard: "\xA1Bienvenidos todos al directo!",
    viewer: "Chat, \xBFesto es real?"
  },
  "Turkish": {
    dashboard: "Herkese yay\u0131na ho\u015F geldiniz!",
    viewer: "Chat, bu ger\xE7ek mi?"
  },
  "Ukrainian": {
  ...
  "Vietnamese": {
    dashboard: "Ch\xE0o m\u1EEBng m\u1ECDi ng\u01B0\u1EDDi \u0111\u1EBFn v\u1EDBi stream!",
    viewer: "Chat, c\xE1i n\xE0y c\xF3 th\u1EADt kh\xF4ng?"
  },
  "Thai": {
  ...
  "Czech": {
    dashboard: "V\xEDtejte v\u0161ichni na streamu!",
    viewer: "Chat, je to pravda?"
  },
  "Finnish": {
    dashboard: "Tervetuloa kaikki streamiin!",
    viewer: "Chat, onko t\xE4m\xE4 totta?"
  },
  "Hindi": {
  ...
  "Swedish": {
    dashboard: "V\xE4lkommen alla till streamen!",
    viewer: "Chat, \xE4r det sant?"
  },
  "Croatian": {
  ...
  "Hungarian": {
    dashboard: "\xDCdv\xF6z\xF6lj\xFCk mindenkit a streamben!",
    viewer: "Chat, ez igaz?"
  },
  "Norwegian": {
    dashboard: "Velkommen alle til streamen!",
