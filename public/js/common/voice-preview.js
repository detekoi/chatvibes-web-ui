 ...
 * @param {object} [options.playerElements]
 * @param {object} [options.hintElements]
 * @param {function} [options.onAudioGenerated]
 * @returns {Promise<string|undefined>} The audio URL, if available.
 */
export async function performVoiceTest(payload, buttons = [], options = {}) {
